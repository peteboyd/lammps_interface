UFF_DATA = {
    ...
    # new terms
    "O_3_f": (0.634, 109.47, 3.5, 0.06, 14.085, 2.3),
    "O_2_z": (0.528, 120.0,  3.5, 0.06, 14.085, 2.3),
    "Al6+3": (1.22,   90.0,  4.499, 0.505, 11.278, 1.792),
    "Sc6+3": (1.44, 90.0, 3.295, 0.019, 12.0, 2.595),
    "Ti4+2": (1.38, 90.0, 3.175, 0.017, 12.0, 2.659),
    "V_4+2": (1.18, 90.0, 3.144, 0.016, 12.0, 2.679),
    "V_6+3": (1.30, 90.0, 3.144, 0.016, 12.0, 2.679),
    "Cr4+2": (1.10, 90.0, 3.023, 0.015, 12.0, 2.463),
    "Cr6f3": (1.28, 90.0, 3.023, 0.015, 12.0, 2.463),
    "Mn6+3": (1.34, 90.0, 2.961, 0.013, 12.0, 2.43),
    "Mn4+2": (1.26, 90.0, 2.961, 0.013, 12.0, 2.43),
    "Fe6+3": (1.32, 90.0, 2.912, 0.013, 12.0, 2.43),
    "Fe4+2": (1.10, 90.0, 2.912, 0.013, 12.0, 2.43),
    "Co3+2": (1.24, 109.47, 2.872, 0.014, 12.0, 1.308),
    "Co4+2": (1.16, 90.0, 2.872, 0.014, 12.0, 1.308),
    "Cu4+2": (1.28, 90.0, 3.495, 0.005, 12.0, 2.43),
    "Zn4+2": (1.34, 90.0, 2.763, 0.124, 12.0, 1.308),
    "Zn3f2": (1.24, 109.47, 2.763, 0.124, 12.0, 1.308)
}
